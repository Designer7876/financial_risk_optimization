...
classifier = decompress_pickle('rfc_compressed.pbz2')

@st.cache()
def prediction(open_acc,earliest_cr_year,fico_range,annual_inc,revol_bal,revol_util,
               dti,int_rate,loan_amnt,last_pymnt_amnt):
    prediction = classifier.predict([[open_acc,earliest_cr_year,fico_range,annual_inc,revol_bal,
...
def main():
    ...
    if st.button("Predict"):
        result = prediction(open_acc,earliest_cr_year,
